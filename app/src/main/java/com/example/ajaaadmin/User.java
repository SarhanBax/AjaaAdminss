...
public class User
{
    ...
    public static class Userlogin
    {
        ...
        private Passenger_status passenger_status;

        @SerializedName("driver_status")
        private String driver_status;

        @SerializedName("admin_status")
        private Admin_status admin_status;
        ...
        public Passenger_status getPassenger_status() {
            return passenger_status;
        }

        public void setPassenger_status(Passenger_status passenger_status) {
        ...
        public Admin_status getAdmin_status() {
            return admin_status;
        }

        public void setAdmin_status(Admin_status admin_status) {
