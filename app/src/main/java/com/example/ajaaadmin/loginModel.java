...
public class loginModel
{
    ...
    private User.Msg message;

    @SerializedName("user")
    private User.Userlogin user;
    ...
    public User.Msg getMessage() {
        return message;
    }

    public void setMessage(User.Msg message) {
        this.message = message;
    }

    public User.Userlogin getUser() {
        return user;
    }

    public void setUser(User.Userlogin user) {
        this.user = user;
    }
    ...
    public static class Userlogin
    {
        ...
        private User.Userlogin.Passenger_status passenger_status;

        @SerializedName("driver_status")
        private String driver_status;

        @SerializedName("admin_status")
        private User.Userlogin.Admin_status admin_status;

        @SerializedName("driver_app_status")
        private String driver_app_status;

        @SerializedName("driver_vehicle_status")
        private String driver_vehicle_status;
        ...
        public User.Userlogin.Passenger_status getPassenger_status() {
            return passenger_status;
        }

        public void setPassenger_status(User.Userlogin.Passenger_status passenger_status) {
        ...
        public User.Userlogin.Admin_status getAdmin_status() {
            return admin_status;
        }

        public void setAdmin_status(User.Userlogin.Admin_status admin_status) {
        ...
        public String getDriver_vehicle_status() {
            return driver_vehicle_status;
        }

        public void setDriver_vehicle_status(String driver_vehicle_status) {
            this.driver_vehicle_status = driver_vehicle_status;
        }
        ...
        public static  class Passenger_status
        {
